        ...
        <div class="col-lg-10">
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Layanan Mahasiswa</li>
                </ol>
            </nav>

            <div class="card shadow-sm border-0">
                <div class="card-body p-5">
                    <h1 class="fw-bold mb-4 border-bottom border-2 border-primary pb-3">Prosedur Pelayanan BAAK</h1>
